...
function HeroContent() {
   return (
      <motion.div initial="hidden" animate="visible" className="flex items-center justify-center px-20 mt-52 w-full z-20">
         <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
            ...
            <motion.p variants={slideInFromLeft(0.2)} className={`${fontInter.className} flex flex-col mt-2 text-6xl font-bold text-white max-w-[600px] size-auto`}>
               <span>
